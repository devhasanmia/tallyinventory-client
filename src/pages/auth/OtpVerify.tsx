                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div>
                        <input
                            ...
                            className={`w-full px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 ${errors.otp ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
                                }`}
                        />
                        {errors.otp && (
